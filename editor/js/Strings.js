	...
	const values = {
		fa: {
			...
			'prompt/rendering/realistic/unsupportedMaterial': 'REALISTIC Shading: Only MeshStandardMaterial and MeshPhysicalMaterial are supported',
                        ...
                        'command/ArrayModifier': 'آرایه مارپیچی',
			...
			'sidebar/geometry/type': 'انواع',
                        ...
                        'sidebar/geometry/clipboard': 'کلیپ بورد هندسه',
                        'sidebar/geometry/copy': 'کپی',
                        'sidebar/geometry/paste': 'پیست',
...
'sidebar/geometry/compute_bounding_box': 'محاسبه جعبه مرزی',
'sidebar/geometry/compute_bounding_sphere': 'محاسبه کره مرزی',
'sidebar/geometry/merge_vertices': 'ادغام راس ها',
'sidebar/geometry/repair': 'ابزار ترمیم و تحلیل',
'sidebar/geometry/repair/tolerance': 'تلرانس',
'sidebar/geometry/repair/analyze': 'تحلیل هندسه',
'sidebar/geometry/repair/merge_tolerance': 'ادغام بر اساس تلرانس',
'sidebar/geometry/repair/check_watertight': 'بررسی آب بندی',
'sidebar/geometry/repair/visualize': 'تصویری',
'sidebar/geometry/repair/highlight_floating': 'هایلایت سطوح جدا',
'sidebar/geometry/repair/smooth_normals': 'هموارسازی نرمال ها',
'sidebar/geometry/repair/clear_helpers': 'حذف نمایشگرها',
'sidebar/geometry/inset_shape': 'تو رفتگی شکل',
'sidebar/geometry/extrude_shape': 'اکسترود شکل',
'sidebar/geometry/array_spiral': 'آرایه مارپیچ',
'sidebar/geometry/array_spiral/count': 'تعداد',
'sidebar/geometry/array_spiral/radius': 'شعاع',
'sidebar/geometry/array_spiral/height': 'ارتفاع',
'sidebar/geometry/array_spiral/degrees': 'درجه در هر گام',
'sidebar/geometry/array_spiral/face_outward': 'چرخش به بیرون',
'sidebar/geometry/array_spiral/apply': 'اجرای آرایه',
'sidebar/geometry/center': 'وسط',
			'sidebar/geometry/selection_mode': 'حالت انتخاب',
			'sidebar/geometry/selection/object': 'شیء',
			'sidebar/geometry/selection/vertex': 'راس',
			'sidebar/geometry/selection/edge': 'لبه',
			'sidebar/geometry/selection/face': 'سطح',
			'sidebar/geometry/selection_info': 'انتخاب',
			...
			'sidebar/project/video/encoding': 'رمزگذاری',
			'sidebar/project/video/size': 'حجم',
			...
			'sidebar/settings/shortcuts': 'شورت کات ها',
                        ...
                        'sidebar/settings/shortcuts/commandTerminal': 'ترمینال فرمان',
			...
			'viewport/info/rendertime': 'زمان رندر',
                        'viewport/info/selection_mode': 'حالت انتخاب',
                        'viewport/info/selection': 'انتخاب',

                        'viewport/command/title': 'ترمینال فرمان',
                        'viewport/command/prompt': 'دستور',
                        'viewport/command/placeholder': 'یک دستور وارد کنید و Enter را بزنید',
                        'viewport/command/help': 'دستورات: help, select <name|uuid>, delete, focus, mode <object|vertex|edge|face>, move <x> <y> <z>, copygeom, pastegeom',
                        'viewport/command/result/selected': 'انتخاب شد: {name}',
                        'viewport/command/result/deleted': 'حذف شد: {name}',
                        'viewport/command/result/focused': 'فوکوس روی {name}',
                        'viewport/command/result/mode': 'حالت انتخاب: {mode}',
                        'viewport/command/result/moved': 'جابجا شد به {position}',
                        'viewport/command/result/copied': 'هندسه کپی شد از {name}',
                        'viewport/command/result/pasted': 'هندسه جایگزین شد برای {name}',
                        'viewport/command/error/select': 'هیچ آبجکتی برای "{query}" یافت نشد',
                        'viewport/command/error/selection_required': 'ابتدا یک آبجکت را انتخاب کنید.',
                        'viewport/command/error/move_arguments': 'move به سه عدد (x y z) نیاز دارد.',
                        'viewport/command/error/geometry_clipboard': 'حافظه هندسه خالی است.',
                        'viewport/command/error/unknown': 'دستور ناشناس: {command}',
                        'viewport/command/error/mode': 'حالت مجاز: object, vertex, edge, face',
		...
		en: {
			...
			'prompt/rendering/realistic/unsupportedMaterial': 'REALISTIC Shading: Only MeshStandardMaterial and MeshPhysicalMaterial are supported',
                        ...
                        'command/ArrayModifier': 'Array Modifier',
			...
			'sidebar/object/export': 'Export JSON',
                        ...
                        'sidebar/geometry/clipboard': 'Geometry clipboard',
...
'sidebar/geometry/compute_bounding_box': 'Compute Bounding Box',
'sidebar/geometry/compute_bounding_sphere': 'Compute Bounding Sphere',
'sidebar/geometry/merge_vertices': 'Merge Vertices',
'sidebar/geometry/repair': 'Repair & Analysis',
'sidebar/geometry/repair/tolerance': 'Tolerance',
'sidebar/geometry/repair/analyze': 'Analyze Geometry',
'sidebar/geometry/repair/merge_tolerance': 'Merge by Tolerance',
'sidebar/geometry/repair/check_watertight': 'Check Watertight',
'sidebar/geometry/repair/visualize': 'Visualize',
'sidebar/geometry/repair/highlight_floating': 'Highlight Floating Faces',
'sidebar/geometry/repair/smooth_normals': 'Smooth Normals',
'sidebar/geometry/repair/clear_helpers': 'Clear Visualizations',
'sidebar/geometry/inset_shape': 'Inset Shape',
'sidebar/geometry/extrude_shape': 'Extrude Shape',
'sidebar/geometry/array_spiral': 'Spiral Array',
'sidebar/geometry/array_spiral/count': 'Count',
'sidebar/geometry/array_spiral/radius': 'Radius',
'sidebar/geometry/array_spiral/height': 'Height',
'sidebar/geometry/array_spiral/degrees': 'Degrees/Step',
'sidebar/geometry/array_spiral/face_outward': 'Face Outward',
'sidebar/geometry/array_spiral/apply': 'Apply Array',
'sidebar/geometry/center': 'Center',
			...
			'sidebar/project/video/encoding': 'Encoding',
			'sidebar/project/video/size': 'Size',
			...
			'sidebar/settings/shortcuts/translate': 'Translate',
                        ...
                        'sidebar/settings/shortcuts/commandTerminal': 'Command terminal',
                        'sidebar/settings/shortcuts/selectionObject': 'Selection Object',
                        'sidebar/settings/shortcuts/selectionVertex': 'Selection Vertex',
                        'sidebar/settings/shortcuts/selectionEdge': 'Selection Edge',
			'sidebar/settings/shortcuts/selectionFace': 'Selection Face',
			...
			'viewport/info/selection_mode': 'Selection mode',
                        'viewport/info/selection': 'Selection',

                        'viewport/command/title': 'Command terminal',
                        'viewport/command/prompt': 'Command',
                        'viewport/command/placeholder': 'Type a command and press Enter',
                        'viewport/command/help': 'Commands: help, select <name|uuid>, delete, focus, mode <object|vertex|edge|face>, move <x> <y> <z>, copygeom, pastegeom',
                        'viewport/command/result/selected': 'Selected: {name}',
                        'viewport/command/result/deleted': 'Deleted: {name}',
                        'viewport/command/result/focused': 'Focused on {name}',
                        'viewport/command/result/mode': 'Selection mode: {mode}',
                        'viewport/command/result/moved': 'Moved to {position}',
                        'viewport/command/result/copied': 'Copied geometry from {name}',
                        'viewport/command/result/pasted': 'Replaced geometry on {name}',
                        'viewport/command/error/select': 'No object found for "{query}"',
                        'viewport/command/error/selection_required': 'Select an object first.',
                        'viewport/command/error/move_arguments': 'move requires three numbers (x y z).',
                        'viewport/command/error/geometry_clipboard': 'Geometry clipboard is empty.',
                        'viewport/command/error/unknown': 'Unknown command: {command}',
                        'viewport/command/error/mode': 'Allowed modes: object, vertex, edge, face',
		...
		fr: {
			...
			'sidebar/settings/shortcuts/translate': 'Position',
                        ...
                        'sidebar/settings/shortcuts/focus': 'Focus',
                        'sidebar/settings/shortcuts/commandTerminal': 'Terminal de commande',
			...
			'viewport/info/sample': 'Échantillon',
                        ...
                        'viewport/command/title': 'Terminal de commande',
                        'viewport/command/prompt': 'Commande',
                        'viewport/command/placeholder': 'Saisissez une commande puis appuyez sur Entrée',
                        'viewport/command/help': 'Commandes : help, select <name|uuid>, delete, focus, mode <object|vertex|edge|face>, move <x> <y> <z>, copygeom, pastegeom',
                        'viewport/command/result/selected': 'Sélectionné : {name}',
                        'viewport/command/result/deleted': 'Supprimé : {name}',
                        'viewport/command/result/focused': 'Focus sur {name}',
                        'viewport/command/result/mode': 'Mode de sélection : {mode}',
                        'viewport/command/result/moved': 'Déplacé vers {position}',
                        'viewport/command/result/copied': 'Géométrie copiée depuis {name}',
                        'viewport/command/result/pasted': 'Géométrie remplacée sur {name}',
                        'viewport/command/error/select': 'Aucun objet trouvé pour "{query}"',
                        'viewport/command/error/selection_required': 'Sélectionnez d\'abord un objet.',
                        'viewport/command/error/move_arguments': 'move nécessite trois nombres (x y z).',
                        'viewport/command/error/geometry_clipboard': 'Le presse-papiers de géométrie est vide.',
                        'viewport/command/error/unknown': 'Commande inconnue : {command}',
                        'viewport/command/error/mode': 'Modes autorisés : object, vertex, edge, face',
		...
		zh: {
			...
			'sidebar/settings/shortcuts': '快捷键',
                        ...
                        'sidebar/settings/shortcuts/commandTerminal': '命令终端',
			...
			'viewport/info/triangles': '三角形',
                        ...
                        'viewport/command/title': '命令终端',
                        'viewport/command/prompt': '命令',
                        'viewport/command/placeholder': '输入命令并按 Enter',
                        'viewport/command/help': '命令：help, select <name|uuid>, delete, focus, mode <object|vertex|edge|face>, move <x> <y> <z>, copygeom, pastegeom',
                        'viewport/command/result/selected': '已选择：{name}',
                        'viewport/command/result/deleted': '已删除：{name}',
                        'viewport/command/result/focused': '聚焦于 {name}',
                        'viewport/command/result/mode': '选择模式：{mode}',
                        'viewport/command/result/moved': '移动到 {position}',
                        'viewport/command/result/copied': '已从 {name} 复制几何体',
                        'viewport/command/result/pasted': '已在 {name} 上替换几何体',
                        'viewport/command/error/select': '未找到对象 "{query}"',
                        'viewport/command/error/selection_required': '请先选择一个对象。',
                        'viewport/command/error/move_arguments': 'move 需要三个数字 (x y z)。',
                        'viewport/command/error/geometry_clipboard': '几何体剪贴板为空。',
                        'viewport/command/error/unknown': '未知命令：{command}',
                        'viewport/command/error/mode': '可用模式：object, vertex, edge, face',
		...
		ja: {
			...
			'sidebar/settings/shortcuts/translate': '移動',
                        ...
                        'sidebar/settings/shortcuts/commandTerminal': 'コマンドターミナル',
			...
			'viewport/info/vertices': '頂点',
                        ...
                        'viewport/command/title': 'コマンドターミナル',
                        'viewport/command/prompt': 'コマンド',
                        'viewport/command/placeholder': 'コマンドを入力して Enter を押してください',
                        'viewport/command/help': 'コマンド: help, select <name|uuid>, delete, focus, mode <object|vertex|edge|face>, move <x> <y> <z>, copygeom, pastegeom',
                        'viewport/command/result/selected': '選択: {name}',
                        'viewport/command/result/deleted': '削除: {name}',
                        'viewport/command/result/focused': '{name} にフォーカス',
                        'viewport/command/result/mode': '選択モード: {mode}',
                        'viewport/command/result/moved': '{position} に移動',
                        'viewport/command/result/copied': '{name} からジオメトリをコピー',
                        'viewport/command/result/pasted': '{name} のジオメトリを置換',
                        'viewport/command/error/select': 'オブジェクトが見つかりません "{query}"',
                        'viewport/command/error/selection_required': '先にオブジェクトを選択してください。',
                        'viewport/command/error/move_arguments': 'move には 3 つの数値 (x y z) が必要です。',
                        'viewport/command/error/geometry_clipboard': 'ジオメトリのクリップボードが空です。',
                        'viewport/command/error/unknown': '不明なコマンド: {command}',
                        'viewport/command/error/mode': '利用可能なモード: object, vertex, edge, face',
		...
		ko: {
			...
			'sidebar/settings/shortcuts/translate': '이동',
                        ...
                        'sidebar/settings/shortcuts/commandTerminal': '명령 터미널',
			...
			'toolbar/local': '로컬',
                        ...
                        'viewport/command/title': '명령 터미널',
                        'viewport/command/prompt': '명령',
                        'viewport/command/placeholder': '명령을 입력하고 Enter 키를 누르세요',
                        'viewport/command/help': '명령: help, select <name|uuid>, delete, focus, mode <object|vertex|edge|face>, move <x> <y> <z>, copygeom, pastegeom',
                        'viewport/command/result/selected': '선택됨: {name}',
                        'viewport/command/result/deleted': '삭제됨: {name}',
                        'viewport/command/result/focused': '{name} 에 포커스',
                        'viewport/command/result/mode': '선택 모드: {mode}',
                        'viewport/command/result/moved': '{position} 로 이동',
                        'viewport/command/result/copied': '{name} 에서 지오메트리를 복사',
                        'viewport/command/result/pasted': '{name} 지오메트리를 교체함',
                        'viewport/command/error/select': '"{query}" 객체를 찾을 수 없습니다',
                        'viewport/command/error/selection_required': '먼저 객체를 선택하세요.',
                        'viewport/command/error/move_arguments': 'move 는 세 개의 숫자 (x y z)가 필요합니다.',
                        'viewport/command/error/geometry_clipboard': '지오메트리 클립보드가 비어 있습니다.',
                        'viewport/command/error/unknown': '알 수 없는 명령: {command}',
                        'viewport/command/error/mode': '가능한 모드: object, vertex, edge, face',
